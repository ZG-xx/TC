...
DELETE FROM `creature_template_addon` WHERE `entry` IN (37690,37672,36659,38186,37945,38429,38430,37918,37006,37186,37985);
...
(37985, 0, 0, 0, 0, 0, '70876 0');

-- Thanks YTDB

-- Conditions

DELETE FROM `conditions` WHERE `SourceEntry` IN (69508,70881,70360,36659,70781,70856,70857,70858,70859,70860,70861,69157,71614,70588,74074,71948);
...
(13,0,71948,0,18,1,37950,0,0, '', 'Valithria - Share damage'),
...
DELETE FROM `spell_script_names` WHERE `spell_id` = 71721;
DELETE FROM `spell_script_names` WHERE `spell_id` = 70501;
DELETE FROM `spell_script_names` WHERE `spell_id` = 68576;
DELETE FROM `spell_script_names` WHERE `spell_id` = 69030;
DELETE FROM `spell_script_names` WHERE `ScriptName`='spell_cultist_dark_martyrdom';
DELETE FROM `spell_script_names` WHERE `ScriptName`='spell_deathwhisper_mana_barrier';
