        ...
        struct boss_garfrostAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/)
            {
                ...
                if (instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
                    me->SummonCreature(NPC_MARTIN_VICTUS_1, 686.16f, -153.0f, 528.06f, 5.2292f, TEMPSUMMON_MANUAL_DESPAWN);
                else
                    me->SummonCreature(NPC_GORKUN_IRONSKULL_2, 686.16f, -153.0f, 528.06f, 5.2292f, TEMPSUMMON_MANUAL_DESPAWN);
