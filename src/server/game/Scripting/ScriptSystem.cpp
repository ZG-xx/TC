...
void SystemMgr::LoadScriptTexts()
{
    ...
    LoadTrinityStrings("script_texts", TEXT_SOURCE_TEXT_START, TEXT_SOURCE_TEXT_END);
...
void SystemMgr::LoadScriptTextsCustom()
{
    ...
    LoadTrinityStrings("custom_texts", TEXT_SOURCE_CUSTOM_START, TEXT_SOURCE_CUSTOM_END);
...
{
    sLog->outString("TSCR: Loading Gossip Texts...");
    LoadTrinityStrings("gossip_texts", TEXT_SOURCE_GOSSIP_START, TEXT_SOURCE_GOSSIP_END);
}
